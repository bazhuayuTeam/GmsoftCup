...
public class ExcelMatch{
	...
	//对模板数据进行匹配
	public boolean matchTemplate(String templateName, String filePath, int sheetIndex, int startLine){
		boolean result = false; 
		if(!StringUtil.isEmpty(templateName) || !StringUtil.isEmpty(filePath)){//判断文件是否存在
			String templatePath = systemUtil.getSystemParameter(templateName);
