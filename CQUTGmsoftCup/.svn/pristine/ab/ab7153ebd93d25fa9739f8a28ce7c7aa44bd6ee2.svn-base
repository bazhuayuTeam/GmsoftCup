...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	JQueryLoader loader = new JQueryLoader("dwr,dialog,jqGrid,userDialogValid,tips,file,commonStyle,addAndEdit,dialogNew,nicescroll");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<table class="inputs">
				<tr>
					...
					<td>
						...
						<button type="button" style="position:absolute;margin-left:20px;top:208px;" class="buttonOfGreen" onclick="choosePerson()">选择人员</button>
					</td>
				</tr>
				<tr >
		...
		<script type="text/javascript" src="js/module/operatorManager/operatorEdit.js"></script>
