...
<html>
	...
	<body>
		<div id="dialog-modal" title="添加组员">
		<div style='border: solid 1 #AAAAAA; padding: 20px'>
				<table width="90%">
					<tr>
						<td class="lableWord">账号</td>
						<td style="width: 170px;">
							<input class="inputEdit" type="text" id='forid' field='modulename' save='true'/>
						</td>
					</tr>
					<tr>
					<label id="warn" style="color:red;display:none">该学生未注册，请确定注册后再添加!</label>
					</tr>
				</table>
			</div>
		</div>
		<script type="text/javascript" src='<%=path%>/js/module/personalCenter/competition/StudentAdd.js'></script>
	</body>
