...
ServiceLoader serviceLoader=new ServiceLoader("CodeTableService,AcademicService");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="dialog-modal" title="新增"	style='min-height: 90%; margin: 0 auto; overflow-x: hidden; overflow-y: auto'>
			<div class="hint" id="hint"></div>
				<table class="inputs">
					<tr>
						<td class="lableWord">部门代号</td>
						<td>
							<input  id='academicCode' class="inputEdit">
						</td>
      ...
      <script type='text/javascript' src='<%=path%>/js/module/academic/academicAdd.js'></script>>
	</body>
</html>
