...
<%
	...
	JQueryLoader loader = new JQueryLoader(
			"jqGrid,dwr,dialogNew,tips,mask,watermark,wordStyle,commonStyle,pageBasic,searchBox");
	ServiceLoader serviceLoader = new ServiceLoader(
			"TeamService,GameStepService,GameService");
%>
<html>
	<head>
...
.currentAddress:HOVER {
	...
	<body style="margin-top: 0px; padding: 0;">
		<div class="topStyle">
			<div class="topTitle">报名管理</div>
			<div class="operateRight">
				<span> | </span>
				<span><a onclick="exportData();">导出</a></span>
				<span> | </span>
			</div>
		</div>
		<ul class="searchList" style="position: fixed;top:67px;">
			...
			<%--<li><span class="searchName">参赛形式：</span></li>
			<li>
				<select id="gameStyle" class="searchSelect">
				</select>
			</li>
			...
			<li><span class="searchName">审核状态：</span></li>
			<li>
		...
		<script type="text/javascript" src="js/module/signUpManager/signUpManager.js">
</script>
	</body>
</html>